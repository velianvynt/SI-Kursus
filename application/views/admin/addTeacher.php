...
<div class="row">
    <div class="col-md-12">
        <section class="panel">
            ...
            <form class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/addNewTeacherProcess">
                ...
                <div class="panel-body">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <?php
                                $query = $this->db->query("SELECT max(code) AS terbesar FROM tb_teacher");
                    ...
                    <div class="col-md-4" style="float: right;">
                        ...
                        <a href="<?php echo base_url(); ?>admin/listTeacher" class="btn btn-danger" name="reset" type="reset">
