<section class="panel">
    ...
    <div class="panel-body">
        ...
        <a href="<?= base_url(); ?>staff/addNewStudent" class="btn btn-default btn-success" style="margin-right: 5px;">
                ...
                foreach ($student as $s) : ?> 
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="Edit Data" href="<?= base_url(); ?>staff/editStudent/<?= $s['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                            <a title="Hapus Data" href="<?= base_url(); ?>staff/deleteStudent/<?= $s['id']; ?>" class="btn btn-danger tombol-hapus"><i class="fa fa-trash-alt"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<div class="modal fade" id="modalReport">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>staff/reportStudentPdf" method="POST">
