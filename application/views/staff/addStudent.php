    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>staff/addNewStudentProcess">
                    <section class="content">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="image">Image <span style="color: red;">*</span></label>
                                    <div class="col-md-7">
