<section class="panel">
    ...
    <div class="panel-body">
        ...
        <a class="btn btn-warning" href="<?= base_url('staff/printPdf/') . $class ?>" target="_blank">
            ...
            <tbody>
                ...
                foreach ($table as $ts) : ?>
                    <tr>
                        ...
                        <input type="hidden" value=<?= $class ?> name="class">
                        <td>
                            <a title="Delete Data" href="<?= base_url(); ?>staff/deletePembagian/<?= $ts['id_student']; ?>/<?= $class; ?>" data-class=<?= $class; ?> class="btn btn-danger"><i class="fa fa-trash-alt"></i>
                            </a>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url(); ?>staff/addPembagianProcess">
