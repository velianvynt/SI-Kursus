    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>staff/editStudentProcess">
                    ...
                    <section class="content">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="image" class="col-md-4 control-label">Image <span style="color: red;">*</span></label>
                                    <div class="col-sm-7">
                ...
                <div class="form-group">
                    <div class="col-sm-4" style="float: right;">
                        ...
                        <a href="<?php echo base_url(); ?>staff/listStudent" class="btn btn-danger" name="reset" type="reset">
