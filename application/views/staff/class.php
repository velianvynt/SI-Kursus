<section class="panel">
    ...
    <div class="panel-body">
        ...
        <a href="<?= base_url(); ?>staff/reportClassPdf" class="btn btn-default btn-warning" target="_blank">
                ...
                foreach ($class as $c) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="Hapus Data" href="<?= base_url(); ?>staff/deleteClass/<?= $c['id']; ?>" class="btn btn-danger tombol-hapus"><i class="fa fa-trash-alt"></i></a>
                        </td>
